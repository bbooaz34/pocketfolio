...
- **Details card**: three rows — מחיר רכישה, שער השוק הגולמי, מספר תעודת PSA (link to `psacard.com/cert/<n>`).
- No bottom CTA bar.
